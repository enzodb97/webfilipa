...
export const cuadrosData = [
  {
    ...
    caracteristicas: [
      ...
      'Color de fondo plano a elección',
      'Acabado mate',
      ' Garantía 6 meses'
    ],
    featured: false,
  ...
  },
  {
    ...
    caracteristicas: [
      ...
      'Color de fondo plano, degrade, beteado o estampado a elección.',
      'Acabado mate o brillante a elección.',
      'Incorporación de otros elementos gráficos a la composición.',
      'Detalles en hoja de oro o plata.',
      'Garantía de 1 año.'
    ],
    featured: false,
  }
