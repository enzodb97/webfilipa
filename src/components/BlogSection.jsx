        ...
        <div className="bg-white py-24 sm:py-32" id="Blog">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
              <h2 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Desde el blog</h2>
              <p className="mt-2 text-lg text-gray-600">Aprende a hacer crecer tu negocio con nuestros consejos expertos.</p>
            </div>
            <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              {posts.map((post) => (
                <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
                  <img src={post.image} alt="Post Image" className="w-full h-48 object-cover rounded-lg" />
