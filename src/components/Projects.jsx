...
const Projects = () => {
  ...
  return (
    ...
    overflow-hidden"
      id="Projects"
    >
      <h1 className=" uppercase text-2xl sm:text-4xl  mb-2 text-center catamaran text-yellow font-bold">
        Proyectos{" "}
        <span className="uppercase underline underline-offset-4 decoration-1 under  font-semibold">
          Realizados
        </span>
      </h1>
      <p className="text-center text-gray-500 mb-8 max-w-80-auto ">
        Trabajemos juntos para elevar tu ambiente y llevarlo a otro nivel
      </p>
      {/*slider buttons*/}
