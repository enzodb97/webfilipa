    ...
    const onSubmit = async (event) => {
        ...
        try {
          ...
          if (data.success) {
            ...
            toast.error("UPS! Hubo un error al enviar el mensaje. Intenté en unos minutos");
            setResult("");
          }
        } catch (error) {
      ...
      >
        ...
        <form onSubmit={onSubmit} className="max-w-2xl mx-auto text-gray-600 pt-8">
          ...
          <div className="my-6 text-left">
              Mensaje
              <textarea className="w-full border border-gray-300 rounded py-3 px-4 mt-2 h-48 resize-none" name="Message" placeholder="Escribe tu consulta" required>
              </textarea>
          </div>
